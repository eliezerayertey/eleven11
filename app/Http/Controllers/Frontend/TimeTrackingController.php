...
class TimeTrackingController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.timeTrackings.index', compact('timeTrackings'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.timeTrackings.create', compact('users', 'random_codes', 'shifts', 'locations', 'companies'));
    }
    ...
    public function store(StoreTimeTrackingRequest $request)
    {
        ...
        return redirect()->route('frontend.time-trackings.index');
    }
    ...
    public function edit(TimeTracking $timeTracking)
    {
        ...
        return view('frontend.timeTrackings.edit', compact('users', 'random_codes', 'shifts', 'locations', 'companies', 'timeTracking'));
    }
    ...
    public function show(TimeTracking $timeTracking)
    {
        ...
        return view('frontend.timeTrackings.show', compact('timeTracking'));
    }
