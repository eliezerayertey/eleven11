...
class UsersController extends Controller
{
    ...
    public function index()
    {
        ...
        $users = User::with(['roles', 'company', 'media'])->get();
    ...
    public function create()
    {
        ...
        return view('frontend.users.create', compact('roles', 'companies'));
    }
    ...
    public function edit(User $user)
    {
        ...
        return view('frontend.users.edit', compact('roles', 'companies', 'user'));
    }
    ...
    public function show(User $user)
    {
        ...
        $user->load('roles', 'company', 'userUserAlerts');
